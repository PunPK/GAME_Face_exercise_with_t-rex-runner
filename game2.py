...
with map_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh:
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            frame = utils.textWithBackground(frame, f'Re Face : {reface}', FONTS, 1.0, (500, 100), bgOpacity=0.9, textThickness=2)
            frame = utils.textWithBackground(frame, f'Re eye right : {reEYE}', FONTS, 1.0, (500, 200), bgOpacity=0.9, textThickness=2)
            frame = utils.textWithBackground(frame, f'Re eye left : {leEYE}',FONTS, 1.0, (500, 300), bgOpacity=0.9, textThickness=2)
            frame = utils.textWithBackground(frame, f'Re Yawn : {reYawn}',FONTS, 1.0, (500, 400), bgOpacity=0.9, textThickness=2)
